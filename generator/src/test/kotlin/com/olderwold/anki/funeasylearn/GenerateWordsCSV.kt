...
class GenerateWordsCSV {
    ...
    fun words_hu_641_660() {
        generateWords(start = 641, end = 660, language = Language.HU)
    }

    @Test
    @OkReplay
    fun words_hu_661_680() {
        generateWords(start = 661, end = 680, language = Language.HU)
    }
    ...
    fun words_hu_701_720() {
        generateWords(start = 701, end = 720, language = Language.HU)
    }

    @Test
    @OkReplay(mode = TapeMode.WRITE_ONLY)
    fun words_hu_721_740() {
        generateWords(start = 721, end = 740, language = Language.HU)
    }
